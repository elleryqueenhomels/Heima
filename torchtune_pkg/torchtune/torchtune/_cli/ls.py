...
class List(Subcommand):
    ...
    def __init__(self, subparsers: argparse._SubParsersAction):
        ...
        self._parser = subparsers.add_parser(
            ...
            description="List all built-in recipes and main_python",
    ...
    def _ls_cmd(self, args: argparse.Namespace) -> None:
        """List all available recipes and main_python."""
        # Print table header
        ...
        for recipe in get_all_recipes():
            # If there are no main_python for a recipe, print a blank config
            ...
            for i, config in enumerate(recipe.configs):
                # If there are multiple main_python for a single recipe, omit the recipe name
                # on latter main_python
                if i > 0:
                    recipe_str = ""
