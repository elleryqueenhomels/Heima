...
class Copy(Subcommand):
    ...
    def __init__(self, subparsers):
        ...
        self._parser = subparsers.add_parser(
            ...
            Need to see all possible recipes/main_python to copy? Try running `tune ls`.
            """
            ),
    ...
    def _cp_cmd(self, args: argparse.Namespace):
        ...
        # Iterate through all recipes and main_python
        for recipe in get_all_recipes():
            ...
            for config in recipe.configs:
                if config.name == args.file:
                    src = ROOT / "recipes" / "main_python" / config.file_path
                    proper_suffix = ".yaml"
                    break
