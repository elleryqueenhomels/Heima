...
with open("/mnt/localssd/llava-cot-dataset/json_files/data_train-num_thinking_token_summary{}_caption{}_reasoning{}-sequence_special_token.json".format(
...
print("Save data_train-num_thinking_token_summary{}_caption{}_reasoning{}-sequence_special_token.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
))

with open("/mnt/localssd/llava-cot-dataset/json_files/data_test-num_thinking_token_summary{}_caption{}_reasoning{}-sequence_special_token.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
), "w") as f:
...
print("Save data_test-num_thinking_token_summary{}_caption{}_reasoning{}-sequence_special_token.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
))
