...
for idx, whole_sample in enumerate(total_data):
    ...
    for i in range(0, len(whole_sample['conversations']), 2):
        ...
        thinking_answer_caption = current_answer.replace(
            current_caption, "<THINKING_OF_CAPTION>"*length_current_num_caption_tokens
        )
        thinking_answer_caption_summary = thinking_answer_caption.replace(
            current_summary, "<THINKING_OF_SUMMARY>"*length_current_num_summary_tokens
        )
        thinking_answer_caption_summary_reasoning = thinking_answer_summary_caption.replace(
            current_reasoning, "<THINKING_OF_REASONING>"*length_current_num_reasoning_tokens
        )
        thinking_answer_reasoning = current_answer.replace(
            current_reasoning, "<THINKING_OF_REASONING>"*length_current_num_reasoning_tokens
        )
        thinking_answer_reasoning_caption = thinking_answer_reasoning.replace(
            current_caption, "<THINKING_OF_CAPTION>"*length_current_num_caption_tokens
        )
        thinking_answer_reasoning_caption_summary = thinking_answer_reasoning_caption.replace(
            current_summary, "<THINKING_OF_SUMMARY>"*length_current_num_summary_tokens
        )
        ...
        both_sample['conversations_compress_caption'][1]['value'] = thinking_answer_caption
        both_sample['conversations_compress_caption_summary'] = copy.deepcopy(thinking_sample['conversations'])
        both_sample['conversations_compress_caption_summary'][1]['value'] = thinking_answer_caption_summary
        both_sample['conversations_compress_caption_summary_reasoning'] = copy.deepcopy(thinking_sample['conversations'])
        both_sample['conversations_compress_caption_summary_reasoning'][1]['value'] = thinking_answer_caption_summary_reasoning
        both_sample['conversations_compress_reasoning'] = copy.deepcopy(thinking_sample['conversations'])
        both_sample['conversations_compress_reasoning'][1]['value'] = thinking_answer_reasoning
        both_sample['conversations_compress_reasoning_caption'] = copy.deepcopy(thinking_sample['conversations'])
        both_sample['conversations_compress_reasoning_caption'][1]['value'] = thinking_answer_reasoning_caption
        both_sample['conversations_compress_reasoning_caption_summary'] = copy.deepcopy(thinking_sample['conversations'])
        both_sample['conversations_compress_reasoning_caption_summary'][1]['value'] = thinking_answer_reasoning_caption_summary
...
with open("/mnt/localssd/llava-cot-dataset/json_files/data_train-num_thinking_token_summary{}_caption{}_reasoning{}.json".format(
...
print("Save data_train-num_thinking_token_summary{}_caption{}_reasoning{}.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
))

with open("/mnt/localssd/llava-cot-dataset/json_files/data_test-num_thinking_token_summary{}_caption{}_reasoning{}.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
), "w") as f:
...
print("Save data_test-num_thinking_token_summary{}_caption{}_reasoning{}.json".format(
    compression_ratio_thinking_tokens_summary,
    compression_ratio_thinking_tokens_caption,
    compression_ratio_thinking_tokens_reasoning
))
